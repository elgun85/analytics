    ...
    <div class="col-12">
        ...
        <div class="card recent-sales overflow-auto">
            <div class="card-body d-flex justify-content-between align-items-center">
                ...
                <button wire:click="new" type="button" class="btn btn-primary " data-bs-toggle="modal"
                        data-bs-target="#PersonnelModel"><i class="bi bi-plus"> Add Personnel </i></button>
            </div>
            ...
            <div class="card-body">
                ...
                <table class="table datatable table-hover">
                        ...
                        <tr>
                            ...
                            <td class="align-middle">
                                <div class=" form-switch">
                                    <input wire:click="changeStatus({{$personnel->id}})"
                                           class="form-check-input align-middle" type="checkbox"
                                           id="flexSwitchCheckChecked" {{$personnel->status==1 ? 'checked' : ''}}>
                                </div>
                            </td>
                            <td>
                                <a wire:click.prevent="EditData({{$personnel->id}})" class="btn btn-outline-secondary"
                                   data-bs-toggle="modal" data-bs-target="#PersonnelModel" href="#"><i
                                        class="bi bi-pencil-fill text-primary"></i></a>
                                <a wire:click.prevent="DeleteData({{$personnel->id}})" class="btn btn-outline-secondary"
                                   href="#"><i class="bi bi-trash-fill text-danger"></i></a>
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="text-danger text-center"><h5>Not found data </h5></td>
                        </tr>
