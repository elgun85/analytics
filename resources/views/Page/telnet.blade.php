                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ps-3">
                                            ...
                                            <span
                                                class="text-success small pt-1 fw-bold">{{$statistics->statusCount1}}</span>
                                            <span class="text-muted small pt-2 ps-1">aktiv</span>
                                            <span
                                                class="text-danger small pt-1 fw-bold">{{$statistics->statusCount0}}</span>
                                            <span class="text-muted small pt-2 ps-1">passiv</span>
